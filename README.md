<!-- ===================== ANIMATED INTRO ===================== -->
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Poppins&size=24&pause=1000&color=00FFD1&center=true&vCenter=true&width=600&lines=Hi+There,+I+am+Samruth+Sriram;Security+Engineer;Web+%7C+Mobile+%7C+API+Penetration+Testing" />
</p>

<!-- ===================== SHORT DESCRIPTION ===================== -->
<p align="center">
<b>Security Engineer</b> with hands-on expertise in <b>Web, Mobile (Android), API, and Network Penetration Testing</b>.  
Experienced in executing real-world VAPT engagements, participating in public CTFs, and conducting security research —  
with a strong focus on uncovering high-impact vulnerabilities and delivering clear, actionable risk insights.
</p>
